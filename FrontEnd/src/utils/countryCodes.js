export const countryCodes = [
    ...
    { name: "American Samoa", code: "AS", callingCode: "+1-684" },
    { name: "Andorra", code: "AD", callingCode: "+376" },
    { name: "Angola", code: "AO", callingCode: "+244" },
    { name: "Anguilla", code: "AI", callingCode: "+1-264" },
    { name: "Antarctica", code: "AQ", callingCode: "+672" },
    { name: "Antigua and Barbuda", code: "AG", callingCode: "+1-268" },
    ...
    { name: "Bermuda", code: "BM", callingCode: "+1-441" },
    ...
    { name: "British Virgin Islands", code: "VG", callingCode: "+1-284" },
    ...
    { name: "Cayman Islands", code: "KY", callingCode: "+1-345" },
    ...
    { name: "Cocos Islands", code: "CC", callingCode: "+61" },
    ...
    { name: "Curacao", code: "CW", callingCode: "+599" },
    { name: "Cyprus", code: "CY", callingCode: "+357" },
    { name: "Czech Republic", code: "CZ", callingCode: "+420" },
    { name: "Democratic Republic of the Congo", code: "CD", callingCode: "+243" },
    { name: "Denmark", code: "DK", callingCode: "+45" },
    { name: "Djibouti", code: "DJ", callingCode: "+253" },
    { name: "Dominica", code: "DM", callingCode: "+1-767" },
    { name: "Dominican Republic", code: "DO", callingCode: "+1-809, 1-829, 1-849" },
    { name: "East Timor", code: "TL", callingCode: "+670" },
    ...
    { name: "Guam", code: "GU", callingCode: "+1-671" },
    { name: "Guatemala", code: "GT", callingCode: "+502" },
    { name: "Guernsey", code: "GG", callingCode: "+44-1481" },
    ...
    { name: "Isle of Man", code: "IM", callingCode: "+44-1624" },
    ...
    { name: "Jersey", code: "JE", callingCode: "+44-1534" },
    ...
    { name: "Montserrat", code: "MS", callingCode: "+1-664" },
    ...
    { name: "Northern Mariana Islands", code: "MP", callingCode: "+1-670" },
    ...
    { name: "Sint Maarten", code: "SX", callingCode: "+1-721" },
    ...
    { name: "Turks and Caicos Islands", code: "TC", callingCode: "+1-649" },
    { name: "Tuvalu", code: "TV", callingCode: "+688" },
    { name: "U.S. Virgin Islands", code: "VI", callingCode: "+1-340" },
